...
public class DataReciever {
    ...
    public static final DataReciever INSTANCE = new DataReciever();
    private Executor executor;

    private static ArrayList<String> keys;
    private static ArrayList<String> urls;
    private Map<String, Integer> keysPosition = new HashMap<String, Integer>();
    ...
    private void initUrls(ArrayList<String> list) {
    ...
    public void getKeys(DataCallback callback) {
        Amplify.Storage.list(
                ...
                result -> {
                    ...
                    Log.i("DataReciver : getKeys()", String.valueOf(keys));
                    initUrls(keys);
    ...
    public void getUrls(DataCallback callback) {
        ...
        while(true) {
            try {
                if(counter==0){
                    Log.i("DataReciver : getUrls()", String.valueOf(urls));
    ...
    public void downloadFile(Context context, int position) {
        ...
        Amplify.Storage.downloadFile(
                ...
                result -> {
                    ...
                    GalleryData.downloadFinish(context);
